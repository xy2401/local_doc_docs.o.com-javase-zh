/* 
 * @(#)LookupCompoundName.java	1.1 99/10/29
 * 
...
/**
  * Demonstrates how to look up an object using a structured compound name.
  *
  * usage: java LookupCompoundName
  */
class LookupCompoundName {
