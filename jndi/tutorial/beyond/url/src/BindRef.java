...
/**
  * Demonstrates how to use bind a File system reference to the LDAP.
  *
  * usage: java BindRef
  */
class BindRef {
	...
	try {
	    ...
	    // Bind the reference into the LDAP
	    ldapCtx.bind("cn=fs", fsRef);
	    
	    // Read it back an object from the composite namespace
	    Object obj = ldapCtx.lookup("cn=fs/tutorial/report.txt");

	    System.out.println(obj);

	    // Cleanup
	    ldapCtx.unbind("cn=fs");
