/* 
 * @(#)GetAttributeDefn.java	1.3 99/09/21
 * 
...
/**
  * Demonstrates how to get an attribute definition's schema from the corresponding
  * attribute.
  *
  * usage: java GetAttributeDefn
  */
class GetAttributeDefn {
