/* 
 * @(#)ModifyAttributeDefn.java	1.1 01/05/24
 * 
...
/**
  * Demonstrates how to modify an existing attribute definition in the schema.
  *
  * usage: java ModifyAttributeDefn
  */
class ModifyAttributeDefn {
