/* 
 * @(#)DigestBuffer.java	1.1 01/05/24
 * 
 ...
 * using DIGEST-MD5 authentication with integrity protection and
 * a maximum receive buffer size of 16384.
 *
 * usage: java DigestBuffer
 */
class DigestBuffer {
