/* 
 * "@(#)BarContextImpl.java	1.1	00/01/18 SMI"
 * 
...
public class BarContextImpl extends HierCtx implements BarContext {

    public BarContextImpl(Hashtable env) {
	super(env);
    }

    // Method that processes a name
    public Object barMethod(Name name) throws NamingException {
	// A sample method that just returns the same thing as lookup()
	return lookup(name);
    }
    ...
    static BarContextImpl testRoot;
    static {
	try {
	    testRoot = new BarContextImpl(null);
